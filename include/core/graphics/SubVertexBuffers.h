...
namespace Liar
{
	...
	* Int
	*/
	class SubIntVertexBuffer :public Liar::ISubVertexBuffers
	{
	public:
		SubIntVertexBuffer();
		virtual ~SubIntVertexBuffer();

	protected:
		Liar::IntHeapOperator** m_buffers;
		Liar::Int m_numberBuffers;

	public:
		virtual Liar::Int GetSize() const;
		virtual Liar::Int GetFormat() const;
		virtual Liar::Int GetType() const { return GL_INT; };
	...
	* float
	*/
	class SubFloatVertexBuffer :public Liar::ISubVertexBuffers
	{
	public:
		SubFloatVertexBuffer();
		virtual ~SubFloatVertexBuffer();

	protected:
		Liar::FloatHeapOperator** m_buffers;
		Liar::Int m_numberBuffers;
